...
//---------------------------------------------------------------Szövegek-----------------------
 ...
 $langlang='hu';
 $langelem='del';
 $lang[$langelem]["text"][$langlang]="Töröl";
 $lang[$langelem]["img"][$langlang]=
 '<img src="http://icons2.iconarchive.com/icons/milosz-wlazlo/boomy/48/trash-b-icon.png" alt="'.$lang[$langelem]['text'][$langlang].'" title="'. $lang[$langelem]['text'][$langlang].'" '.$langelemproperty.'>';
 ...
 $lang[$langelem]['text'][$langlang]="Feltöltés";
  $lang[$langelem]['img'][$langlang]=
 '<img src="http://www.atwright.co.uk/images/icon_upload.png" alt="'.$lang[$langelem]['text']['hu'].'" title="'. $lang[$langelem]['text'][$langlang].'"  '.$langelemproperty.'>';
 ...
 $lang[$langelem]['img'][$langlang]=
 '<img src="http://www.paranoidferret.com/Images/Tech_Icons/php_icon.jpg" alt="'.$lang[$langelem]['text']['hu'].'" title="'. $lang[$langelem]['text'][$langlang].'"  '.$langelemproperty.'>';
...
<strong><?php echo $lang['dir']['img']['hu'];?><?php echo $lang['newdir']['text']['hu'];?></strong><br />
<br />
...
<strong><?php echo $lang['upload']['img']['hu'];?><?php echo $lang['upload']['text']['hu'];?></strong><br />
<br />
...
<strong><?php echo $lang['rename']['img']['hu'];?><?php echo $lang['rename']['text']['hu'];?></strong><br />
<br />
...
<div id="header" class="header">&nbsp;<a href="?fldr2=<?php echo $dir2;?>&fldr1=<?php echo $dir1;?>"><img src="http://icons.iconarchive.com/icons/zeusbox/gartoon/128/floppy-icon.png"  height="60%" border="0" /></a>Web Manager V1.5 - <?php print($_SERVER["HTTP_HOST"]);?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="?fldr2=<?php echo $dir2;?>&fldr1=<?php echo $dir1;?>&logout=yes"><?php echo $lang['logout']['img']['hu'];?></a>
...
?>
  <tr>
	...
	<td><?php $message=$lang['del']['text']['hu']." ".$elem["path"]."?"; ?>

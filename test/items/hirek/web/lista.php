                                ...
                                if (($hirekelemek)) foreach ($hirekelemek as $data) {
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="hidden-phone">
                                            ...
                                            <a href="<?php echo $server_url . $separator . $_GET['q'] . $separator2 . "dtag=" . $data['id']; ?>"
                                               class="delete-row" data-original-title="Delete">
                                                <img src="<?php echo $server_url; ?>styl/admin/img/trash-icon.png"
                                                     alt="trash">
                                            </a>
                                        </td>
                                    </tr>

...
if ($_GET['dwork']>0){
$gmrec_class->save_list('allergen',array("id"=>$_GET['dwork'],'status'=>'4'));
}
$datas=$gmrec_class->get_list('allergen',array());
              ...
              <div class="widget-body">
				...
				<?php $form->selectboxeasy2('status',$status,$_GET["status"],'status');?>
                  ...
                  <button type="submit" class="btn btn-success" data-original-title="">Search</button>
                    ...
                    <a href="<?php echo $homeurl.$separator."".$getparams[0]."/allergen";?>" class="btn btn-success">
                    New Country
                    </a>
<!-- Row start -->
        <div class="row">
          <div class="col-md-12">
            <div class="widget">
              <div class="widget-header">
                <div class="title">
                  <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span> Country's<br />
                </div>
              </div>
                    ...
                    <?php foreach ($datas as $data){?>
                      ...
                      <tr class="gradeX">
                        ...
                        <td class="hidden-phone">
                          <a href="<?php echo $server_url.$separator."".$getparams[0]."/allergen/".$data['id'];?>" class="actions-icons">

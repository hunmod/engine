...
<?php } ?>
    ...
    <link rel="stylesheet"
          href="<?php echo $homeurl; ?><?php echo $makemin->css('/scripts/jquery.ui.timepicker.css', '/scripts/jquery.ui.timepicker.min.css') ?>"/>
    <link rel="stylesheet"
          href="<?php echo $homeurl; ?><?php echo $makemin->css('/scripts/jquery-ui-timepicker-addon.css', '/scripts/jquery-ui-timepicker-addon.min.css') ?>"/>

    <script
        src="<?php echo $homeurl; ?><?php echo $makemin->js($stylefolder33 . '/scripts/jquery.ui.timepicker.js', $stylefolder33 . '/scripts/jquery.ui.timepicker.min.js', false) ?>"></script>
    <script
        src="<?php echo $homeurl; ?><?php echo $makemin->js($stylefolder33 . '/scripts/jquery-ui-timepicker-addon.js', $stylefolder33 . '/scripts/jquery-ui-timepicker-addon.min.js', false) ?>"></script>

...
switch ($kiterjesztes) {
    ...
    case "bmp":
		...
		imagecopyresampled($image_out, $image_in, 0, 0, $posx, $posy, $ximg, $yimg, imagesx($image_in), imagesy($image_in)) or die("CopyResized error");
...
if ($_GET['picture'] != "") {
		...
		switch($_SERVER["HTTP_HOST"]){	
			...
			default:
				...
				$watermarkarray["ratio"]=1;
				$watermarkarray["pos"]="l-t";
				$watermarkarray["opacity"]=70;
		}	

		$ret=img_resize($theimage,$_GET['x'],$_GET['y'],1,0,$watermarkarray);
		$image_out=$ret['image'];

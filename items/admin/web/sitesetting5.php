                ...
                <div class="tab-content"><!-- add tab panels here -->
                    <?php foreach ($avaibleLang as $alan) { ?>
                        <div class="tab-pane <?php if ($_SESSION['lang'] == $alan) {
                            ...
                            <?php $Form_Class->selectbox("menu_root_" . $alan, $rootmenu_array, array('value' => 'id', 'name' => 'nev'), page_settings("menu_root_" . $alan), 'Rootmenu(' . $alan . ')');?>
                            <label><?= lan("start_page")." ". $alan;?></label>
                            <?php $Form_Class->textbox('start_page_' . $alan, page_settings('start_page_' . $alan), 'Kezdő oldal (' . $alan . ')');?>
                            <label><?= lan("keywords")." " . $alan;?></label>
                            <?php $Form_Class->textbox('keywords_' . $alan, page_settings("keywords_" . $alan), 'Kulcsszavak (Keywords)' . $alan . '');?>
                            <label><?= lan("title")." " . $alan;?></label>
                            <?php $Form_Class->textbox('title_' . $alan, page_settings("title_" . $alan), 'title (Description)' . $alan . '');?>
                            <label><?= lan("description")." " . $alan;?></label>
                            <?php $Form_Class->textbox('description_' . $alan, page_settings("description_" . $alan), 'description (' . $alan . ')');?>
                        </div>

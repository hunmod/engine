...
<div class="egyelem">
	...
	<div class="tblbg3">
        ...
        <a href="<?php echo $kezdooldal.$separator."apro/edittext/".base64_encode($hir["id"]);?>" onmouseover="ddrivetip('szerkeszt')" onmouseout="hideddrivetip()"><?php echo $buttons["edit"];?></a>

...
<new class="col-md-6 col-sm-6 mhbl2" itemscope="" itemtype="http://schema.org/WebPage">
                        <a href="<?php echo $elem["url"];?>" class="box <?php echo $fcolor;?>"  itemprop="url">
                            ...
                            <div class="imgWrap">
										...
										$nimg=$bf_class->getimg($elem['id'],300,148);
											echo $nimg.'';
;?>" alt="<?php echo $Text_Class->htmlfromchars($elem["nev"]);?>"  title="<?php echo $Text_Class->htmlfromchars($elem["nev"]);?>"  >
                            </div>
                            <div class="upArrowDecor"></div>
                            <h2 itemprop="name"><?php echo $Text_Class->htmlfromchars($elem["nev"]);?></h2>
							<p itemprop="description"><?php echo substr($Text_Class->tageketcsupaszit($Text_Class->htmlfromchars($elem["leiras"])),0,200).'...';?></p>

<div class="container">
    <div id="breadCrumb">
        ...
        <span><?php echo "". ($Text_Class->htmlfromchars($aprodata["cim_".$_SESSION["lang"]]));?></span>
    </div>
<?php
/* 
...
<?php } ?>
    ...
    <h1 itemprop="name"><?php echo "". ($Text_Class->htmlfromchars($aprodata["cim_".$_SESSION["lang"]]));?></h1>
    ...
    <top>		
        ...
        <div class="col-sm-6">                
                        ...
                        <?php echo "". ($Text_Class->tageketcsupaszit($Text_Class->htmlfromchars($aprodata["hir_".$_SESSION['lang']])));?>
                        </p>
        </div>          
    </top>  
    <description class="col-sm-12" itemprop="description">
    <?php echo "". ($Text_Class->youtoubecserel($Text_Class->htmlfromchars($aprodata["hir2_".$_SESSION['lang']])));?>
    </description>
    <?php if ($auser["jog"]>2){?>                            
                            <a itemprop="url" class="button enterButton moreButton" href="<?php echo $homeurl.$separator."page/edittext/".encode($aprodata["id"]);;?>"><?php echo $lan["edit"];?></a>
                            <?php }?>
           </news>                  

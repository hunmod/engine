...
if ($che<1){
	...
	else
	{
		...
		include('items/page/web/hir_display_block1.php');

/*
	switch($stn){
	case 1:	
		include('items/page/web/hir_display_short.php');	
	break;
	case 2:	
		include('items/page/web/hir_display_block1.php');
	break;	
	case 3:	
		include('items/page/web/hir_display_block2.php');	
	break;
	default:
		include('items/page/web/hir_display_short_first.php');
	}*/
$counter++;
$che--;
}}

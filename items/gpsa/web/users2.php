<div class="container">
    <section class="col-md-9 col-sm-8">
        ...
        <a href="<?php echo $homeurl . $separator . "" . $getparams[0] . "/edit"; ?>"
           class="btn btn-success"> <?php echo $lan["new"]; ?><?php echo $lan["user"]; ?></a>
        <!-- Row start -->
        <div class="row">
            <div class="col-md-12">
                <div class="widget">
                                ...
                                <?php foreach ($datas as $data) { ?>
                                    <tr class="gradeX">
                                        ...
                                        <td class="hidden-phone">
                                            <a href="<?php echo $server_url . $separator . "user/edit/" . $data['id']; ?>"
                                               class="actions-icons"> Edit</a>
                                            <a href="<?php echo $server_url . $separator . "" . $getparams[0] . "/user_cars/" . $data['id']; ?>"
                                               class="actions-icons"> Cars </a>
                                            <a href="<?php echo $server_url . $separator . $_GET['q'] . $separator2 . "active=" . $data['id'] . '&' . $addtourl; ?>"
                                               class="actions-icons" onclick="return confirm('Are you sure?')"> DEL </a>
                                        </td>
                                    </tr>

...
<div class="container">
    <section class="col-sm-12" >
                    ...
                    <div class="widget-body">
                        <form class="form-inline" role="form">
                            <div class="form-group">
                                ...
                                <?php $form->textbox('s',$_GET["s"],'name',"sr-only");?>
                            </div>
                            <div class="form-group">
        ...
        <a href="<?php echo $homeurl.$separator."".$getparams[0]."/subscriebe_edit";?>" class="btn btn-success"><?= lan('newsubscriebe')?></a>
        <!-- Row start -->
        <div class="row">
            <div class="col-md-12">
                <div class="widget">
                    <div class="widget-header">
                        <div class="title">
                            <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span><?= lan('subscriebe')?><br />
                                ...
                                if (($hirekelemek))foreach ($hirekelemek as $data){?>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="hidden-phone">
                                            <a href="<?php echo $server_url.$separator."".$getparams[0]."/subscriebe_edit/".encode($data['email']);?>" class="actions-icons">
                                                <img src="<?php echo $server_url;?>styl/admin/img/edit-icon.png" alt="edit" class="icons">
                                            </a>
                                            <a href="<?php echo $server_url.$separator.$_GET['q'].$separator2."dtag=".$data['email'];?>" class="delete-row" data-original-title="Delete">

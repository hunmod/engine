                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-sm-5">
                                    ...
                                    <a  href="<?php echo $elem["url"];?>" itemprop="url">
										...
										echo $nimg=$CsomagClass->getimg($elem['id'],800,533);?>" alt="<?php echo $elem["title"];?>"></a>
                                    </div>
                                </div>
                                ...
                                <?php if ($getparams[1]=="fav"){?>
                                 ...
                                 <?php } ?> 
                                    ...
                                    <div class="connectedservices">
                                        ...
                                        <div class="szobaar">
                                            <?= lan('artolelott') ?><strong><?= $elem["priece"]; ?> Ft</strong>/<?= $artipus[$elem["tip"]]; ?><?= lan('artolmogott') ?><br>
                                            <?= lan('artolutan') ?>
                                        </div>
                                    ...
                                    <?php if ($auser["jog"]>3){?>
                                        <a itemprop="url" class="button enterButton moreButton" href="<?php echo $homeurl.$separator."csomag/edittext/".encode($elem["id"]);;?>"><?php echo $lan["edit"];?></a>
                                    <?php }?>
                                </div>

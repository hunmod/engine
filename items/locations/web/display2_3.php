<article itemprop="article"   itemscope="" itemtype="http://schema.org/WebPage" class="col-xs-4 onelocation">
    <img itemprop="image" class="img-100" src="<?php echo $nimg=$PlacesClass->getimg($elem['id'],640,480);?>" alt="<?php echo $elem["title"];?>">
		<div class="text">

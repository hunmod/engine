<article itemprop="article"   itemscope="" itemtype="http://schema.org/WebPage" class="col-xs-6 onelocation">
	<img itemprop="image" class="img-100" src="<?php echo $nimg=$PlacesClass->getimg($elem['id'],640,320);?>" alt="<?php echo $elem["title"];?>">
		<div class="text">

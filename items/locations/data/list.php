<?php
$extrascript[]= '
	<script src="'.$server_url.'scripts/hngps.min.js"></script>
	';
$Sys_Class=new sys();
...
$qhir=$PlacesClass->get($filters,'',$_GET["page"]) ;
...
foreach($hirekelemek as $egy){
	...
	//kép
	$hirekelemek[$n]["image"]=$homeurl.$PlacesClass->getimg($egy["id"]) ;

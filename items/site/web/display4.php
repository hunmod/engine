...
<a  href="<?php echo $TextClass->levag($SiteClass->createurl($elem),100);/*$elem["url"];*/?>" > <img itemprop="image" class="img-100 col-xs-12 " src="<?php echo $nimg=$SiteClass->getimg($elem['id'],800,320);?>" alt="<?php echo $elem["title"];?>">
</a>

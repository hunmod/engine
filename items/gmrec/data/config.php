...
$tbl['gmrec_addon']=$adatbazis["db1_db"].".".$prefix."web_gmrec_addon";
$file_structuct=array();
$file_structuct["modules"]="gmrec";

/*admin menü*/
$adminalmenu=array();
$file_structuct["name"]="allergének";
$file_structuct["file"]="allergenes";
$adminalmenu[]=$file_structuct;

$file_structuct["name"]="Lista";
$file_structuct["file"]="list";
$adminalmenu[]=$file_structuct;

$file_structuct["name"]="GM Receptek";
$file_structuct["file"]="lista";
$file_structuct["alatta"] = $adminalmenu;

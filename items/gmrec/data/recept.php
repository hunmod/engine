...
$qhir=$gmrec_class->get($filters) ;
$aprodata=($qhir['datas'][0]);
$recallergenekarr=$gmrec_class->get_addon(array("recid"=>$hirid), $order = '', $page = 'all');
$recallergenek=$recallergenekarr["datas"];
//
$aprodata["image"]=$gmrec_class->getimg($hirid) ;
...
//arraylist($aprodata);
$alsolistas=$gmrec_class->get(array("mid"=>$aprodata["mid"],"ido"=>$date),' RAND()','all') ;
$alsolistas=$alsolistas["datas"];
//$tags=$gmrec_class->get_ad_tag(array("ad"=>$alsolistas["id"],"status"=>'2'));
...
$page_keywords="";
$page_ogimage=$homeurl.'/'.$gmrec_class->getimg($hirid,800,533) ;
$page_description="";

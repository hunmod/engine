<?php
$fformname='allergen';
$fformtext='Allergének';

//$gmrec_class=new recipe();
$form=new formobjects();
$status=array('2'=>'Active','4'=>'Deleted');
//$users=$jobclass->get_users(array());

if ($_GET['dwork']>0){
$gmrec_class->save_list($fformname,array("id"=>$_GET['dwork'],'status'=>'4'));
}
$datas=$gmrec_class->get_list($fformname,array());
              ...
              <div class="widget-body">
				...
				<?php $form->selectboxeasy2('status',$status,$_GET["status"],'status');?>
                  ...
                  <button type="submit" class="btn btn-success" data-original-title="">Search</button>
                    ...
                    <a href="<?php echo $homeurl.$separator."".$getparams[0]."/".$fformname;?>" class="btn btn-success">
                    New <?= $fformtext;?>
                    </a>
<!-- Row start -->
        <div class="row">
          <div class="col-md-12">
            <div class="widget">
              <div class="widget-header">
                <div class="title">
                  <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span> <?= $fformtext;?><br />
                </div>
              </div>
                    ...
                    <?php foreach ($datas as $data){?>
                      ...
                      <tr class="gradeX">
                        ...
                        <td class="hidden-phone">
                          <a href="<?php echo $server_url.$separator."".$getparams[0]."/".$fformname."/".$data['id'];?>" class="actions-icons">

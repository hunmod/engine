...
<div class="container">
            <!--div id="breadCrumb">
               ...
               if ($auser["jog"]>2){
				?>
                <a href="<?php echo $homeurl.$separator;?>gmrec/edittext">Új hír</a>
                <?php }?>
            </div-->
                <div class="row">
...
<?php } ?>      
 ...
 <?php if ($auser["jogid"]>3){?>
    <a href="<?= $kezdooldal.$separator.$getparams[0]."/edittext/".($elem["id"]);?>">Új recept</a>
<?php }?> 
...
$stn=2;
	...
	switch($stn){
	case 1:	
		include('items/gmrec/web/hir_display_short.php');	
	break;
	case 2:	
		include('items/gmrec/web/hir_display_block1.php');
	break;	
	case 3:	
		include('items/gmrec/web/hir_display_block2.php');	
	break;
	default:
		include('items/gmrec/web/hir_display_short_first.php');
	}
$counter++;
$che--;
}}

        ...
        <div class="row">
          <div class="col-md-12">
            <div class="widget">
              <div class="widget-header">
                <div class="title">
                  <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span>Receptek<br />
                  ...
                  <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">    
                    <thead>
                      <tr>
                        ...
                        <th style="width:5%" class="hidden-phone">Állapot</th>
                        <th style="width:10%" class="hidden-phone">Műveletek</th>
                      </tr>
                    </thead>
                    <tbody>
                    
                    <?php 
					if (($gmrecelemek))foreach ($gmrecelemek as $data){?>

...
$elem["url"]=$gmrec_class->createurl($elem);
...
<new class="col-md-6 col-sm-6 mhbl2" itemscope="" itemtype="http://schema.org/WebPage">
                        <a href="<?php echo $elem["url"];?>" class="box <?php echo $fcolor;?>"  itemprop="url">
                            ...
                            <div class="imgWrap">
										...
										$nimg=$gmrec_class->getimg($elem['id'],300,148);
											echo $nimg.'';
;?>" alt="<?php echo $Text_Class->htmlfromchars($elem["cim"]);?>"  title="<?php echo $Text_Class->htmlfromchars($elem["cim"]);?>"  >
							...
							<p itemprop="description"><?php echo substr($Text_Class->tageketcsupaszit($Text_Class->htmlfromchars($elem["leiras"])),0,130).'...';?></p>

...
function CheckAuthentication()
{
	...
	if(isset($_SESSION['edt']) && $_SESSION['edt'] >= 0 && $_SESSION['edt'] <= 98 && is_numeric($_SESSION['edt'])){
		if(isset($_SESSION['auth_user']) && $_SESSION['auth_user'] >= 0 && $_SESSION['auth_user'] <= 98 && is_numeric($_SESSION['auth_user']))
		{
			return true;
		}else{
			return false;
...
$config['Thumbnails'] = Array(
		'url' => $baseUrl . 'images/ckthumbs/',
		'directory' => $baseDir . 'images/ckthumbs/',
		'enabled' => true,
		'directAccess' => false,
		'maxWidth' => 100,
		'maxHeight' => 100,
